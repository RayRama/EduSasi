package com.smanegeri1sindang.edusasi.YouTubeDL.YouTubeDownloaderFinishedReceiver;
...
public class YouTubeDLReceiver extends BroadcastReceiver {
        ...
        if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)) {
            ...
            if (c.moveToFirst()) {
                ...
                if (status == DownloadManager.STATUS_SUCCESSFUL) {
                    String inPath = c.getString(c.getColumnIndex(DownloadManager.COLUMN_LOCAL_URI)).replace("file:///sdcard/Download", "");
