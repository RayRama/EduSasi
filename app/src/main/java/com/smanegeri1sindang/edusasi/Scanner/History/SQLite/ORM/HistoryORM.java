package com.smanegeri1sindang.edusasi.Scanner.History.SQLite.ORM;
...
import com.smanegeri1sindang.edusasi.Scanner.History.SQLite.DatabaseWrapper;
...
public class HistoryORM implements InterfaceORM<History>{
    ...
    public static final String SQL_CREATE_TABLE = "CREATE TABLE " +
            TABLE_NAME + " (" + COLUMN_ID + " " + COLUMN_ID_TYPE + COMMA_SEPERATOR +
            COLUMN_DATE + " " + COLUMN_DATE_TYPE + COMMA_SEPERATOR +
            COLUMN_CONTEXT + " " + COLUMN_CONTEXT_TYPE + ")";
    ...
    public void add(Context context, History h) {
        ...
        String query = "INSERT INTO " + TABLE_NAME + "(" + COLUMN_DATE + ", " +
                COLUMN_CONTEXT + ") VALUES ( '" + h.getDate() + "', '" + h.getContext() + "' )";
